...
vmax1 = readmatrix('v_max_1.csv');
vmin1 = readmatrix('v_min_1.csv');
vmax = readmatrix('v_max_0.csv');
vmin = readmatrix('v_min_0.csv');
...
% Acetate
 ...
 f4 = figure(4);
% subplot(1,2,1)
surf(vg_val,vo_val,vmax-vmin)
xlabel('glucose uptake [mmol/gDW L]')
ylabel('oxygen uptake [mmol/gDW L]','Rotation',310)
zlabel('(max - min) Acetate flux [mmol/gDW L]')
 zlim([0 7])
...
% 
% subplot(1,2,1)
% surf(vg_val,vo_val,vmin1)
% xlabel('glucose uptake [mmol/gDW L]')
% ylabel('oxygen uptake [mmol/gDW L]','Rotation',310)
% zlabel('min Acetate flux [mmol/gDW L]')
%   zlim([0 11])
% title("FVA (1% suboptimal growth)")
% % title("\mu optimal")
...
% xlabel('glucose uptake [mmol/gDW L]')
% ylabel('oxygen uptake [mmol/gDW L]')
% zlabel('Growth rate')
% % zlim([0 1])
% title("LP")
% % 
