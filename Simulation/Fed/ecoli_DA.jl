...
vk = vk'
 ...
 p11 = plot(ts,xk[:,3],linewidth=2,xaxis="time [h]",yaxis="biomass [g/L]",label="FBA")
 p11 = plot!(ts_min,xk_min[:,3],linewidth=2,linestyle = :dash,xaxis="time [h]",yaxis="biomass [g/L]",label="Min")
 p11 = plot!(ts_max,xk_max[:,3],linewidth=2,linestyle = :dot,xaxis="time [h]",yaxis="biomass [g/L]",label="Max",legend=false,grid = false)

 p12 = plot(ts,xk[:,2],linewidth=2,xaxis="time [h]",yaxis="Acetate [g/L]",label="FBA")
 p12 = plot!(ts_min,xk_min[:,2],linewidth=2,linestyle = :dash,xaxis="time [h]",yaxis="Acetate [g/L]",label="Min")
 p12 = plot!(ts_max,xk_max[:,2],linewidth=2,linestyle = :dot,xaxis="time [h]",yaxis="Acetate [g/L]",label="Max",legend=false,grid = false)

 p14 = plot(ts,xk[:,1],linewidth=2,xaxis="time [h]",yaxis="Glucose [g/L]",label="FBA")
 p14 = plot!(ts_min,xk_min[:,1],linewidth=2,linestyle = :dash,xaxis="time [h]",yaxis="Glucose [g/L]",label="Min")
 p14 = plot!(ts_max,xk_max[:,1],linewidth=2,linestyle = :dot,xaxis="time [h]",yaxis="Glucose [g/L]",label="Max",legend=false,grid = false)

 p13 = plot(ts,xk[:,4],linewidth=2,xaxis="time [h]",yaxis="Oxygen [mmol/L]",label="FBA")
 p13 = plot!(ts_min,xk_min[:,4],linewidth=2,linestyle = :dash,xaxis="time [h]",yaxis="Oxygen [mmol/L]",label="Min")
 p13 = plot!(ts_max,xk_max[:,4],linewidth=2,linestyle = :dot,xaxis="time [h]",yaxis="Oxygen [mmol/L]",label="Max",legend=false,ylims = (0,0.22),grid = false)
...
# g2 = plot(p21,p22,p23,layout=(3,1),reuse = true)
 ...
 p31 = plot(ts,vk[:,1],linewidth=2,xaxis="time [h]",yaxis="Growth rate [1/h]",label="FBA")
 p31 = plot!(ts_min,vk_min[:,1],linewidth=2,linestyle = :dash,xaxis="time [h]",yaxis="Growth rate [1/h]",label="Min")
 p31 = plot!(ts_max,vk_max[:,1],linewidth=2,linestyle = :dot,xaxis="time [h]",yaxis="Growth rate [1/h]",label="Max",grid = false,legend=false)

 p32 = plot(ts,vk[:,2],linewidth=2,xaxis="time [h]",yaxis="Acetate [mmol/gDW L]",label="FBA")
 p32 = plot!(ts_min,vk_min[:,2],linewidth=2,linestyle = :dash,xaxis="time [h]",yaxis="Acetate [mmol/gDW L]",label="Min")
 p32 = plot!(ts_max,vk_max[:,2],linewidth=2,linestyle = :dot,xaxis="time [h]",yaxis="Ac. [mmol/gDW L]",label="Max",grid = false,legend=false)

 p33 = plot(ts,vk[:,3],linewidth=2,xaxis="time [h]",yaxis="Glucose [mmol/gDW L]",label="FBA")
 p33 = plot!(ts_min,vk_min[:,3],linewidth=2,linestyle = :dash,xaxis="time [h]",yaxis="Glucose [mmol/gDW L]",label="Min")
 p33 = plot!(ts_max,vk_max[:,3],linewidth=2,linestyle = :dot,xaxis="time [h]",yaxis="Glucose [mmol/gDW L]",label="Max",grid = false,legend=false)

 p34 = plot(ts,vk[:,4],linewidth=2,xaxis="time [h]",yaxis="Oxygen [mmol/gDW L]",label="FBA")
 p34 = plot!(ts_min,vk_min[:,4],linewidth=2,linestyle = :dash,xaxis="time [h]",yaxis="Oxygen [mmol/gDW L]",label="Min")
 p34 = plot!(ts_max,vk_max[:,4],linewidth=2,linestyle = :dot,xaxis="time [h]",yaxis="Oxygen [mmol/gDW L]",label="Max",grid = false,legend=false)
