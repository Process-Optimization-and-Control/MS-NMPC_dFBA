...
ts = readdlm("ts_rec.csv")
#u = readdlm("u_open_loop.csv")
#save("x_all.jld", "data", x_all)
x_all= load("x_all_rec.jld")["data"]
u = load("u_all_rec.jld")["data"]
...
p21 = plot!(ts,x_all[5,:,2],linewidth=2, c=:blue,xaxis="time [h]",yaxis="Volume [L]",label="Max",legend=false,grid = false)
p21 = plot!(ts,x_all[5,:,3],linewidth=2, c=:blue,xaxis="time [h]",yaxis="Volume [L]",label="Max",legend=false,grid = false)
p21 = plot!(ts,x_all[5,:,4],linewidth=2, c=:blue,xaxis="time [h]",yaxis="Volume [L]",label="Max",legend=false,grid = false)
p21 = plot!(ts,x_all[5,:,5],linewidth=2, c=:blue,xaxis="time [h]",yaxis="Volume [L]",label="Max",legend=false,grid = false)
p21 = plot!(ts,x_all[5,:,6],linewidth=2, c=:blue,xaxis="time [h]",yaxis="Volume [L]",label="Max",legend=false,grid = false)
p21 = plot!(ts,x_all[5,:,7],linewidth=2, c=:blue,xaxis="time [h]",yaxis="Volume [L]",label="Max",legend=false,grid = false)
p21 = plot!(ts,x_all[5,:,8],linewidth=2, c=:blue,xaxis="time [h]",yaxis="Volume [L]",label="Max",legend=false,grid = false)
p21 = plot!(ts,x_all[5,:,9],linewidth=2, c=:blue,xaxis="time [h]",yaxis="Volume [L]",label="Max",legend=false,grid = false)
p21 = plot!(ts,x_all[5,:,10],linewidth=2, c=:blue,xaxis="time [h]",yaxis="Volume [L]",label="Max",legend=false,grid = false)

p23 = plot(ts,u[1,:,1],linewidth=2,xaxis="time [h]",yaxis="F [L/h]",legend=false, c=:blue, linetype=:steppre,grid = false) 
...
p23 = plot!(ts,u[1,:,2],linewidth=2,xaxis="time [h]",yaxis="F [L/h]",legend=false, c=:blue, linetype=:steppre,grid = false) 
p23 = plot!(ts,u[1,:,3],linewidth=2,xaxis="time [h]",yaxis="F [L/h]",legend=false, c=:blue, linetype=:steppre,grid = false) 
p23 = plot!(ts,u[1,:,4],linewidth=2,xaxis="time [h]",yaxis="F [L/h]",legend=false, c=:blue, linetype=:steppre,grid = false) 
p23 = plot!(ts,u[1,:,5],linewidth=2,xaxis="time [h]",yaxis="F [L/h]",legend=false, c=:blue, linetype=:steppre,grid = false) 
p23= plot!(ts,u[1,:,6],linewidth=2,xaxis="time [h]",yaxis="F [L/h]",legend=false, c=:blue, linetype=:steppre,grid = false) 
p23 = plot!(ts,u[1,:,7],linewidth=2,xaxis="time [h]",yaxis="F [L/h]",legend=false, c=:blue, linetype=:steppre,grid = false) 
p23 = plot!(ts,u[1,:,8],linewidth=2,xaxis="time [h]",yaxis="F [L/h]",legend=false, c=:blue, linetype=:steppre,grid = false) 
p23 = plot!(ts,u[1,:,9],linewidth=2,xaxis="time [h]",yaxis="F [L/h]",legend=false, c=:blue, linetype=:steppre,grid = false) 
p23 = plot!(ts,u[1,:,10],linewidth=2,xaxis="time [h]",yaxis="F [L/h]",legend=false, c=:blue, linetype=:steppre,grid = false) 
...
savefig(g1,"closed_loop_scn_states.pdf")
savefig(g2,"closed_loop_scn_control.pdf")
